...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.25.100"), 12124)}, "/Users/Evgenii/Desktop/Fuse/weather-app/weather-app.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("weather-app");
}
}
}
