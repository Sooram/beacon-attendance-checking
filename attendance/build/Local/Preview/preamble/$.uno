...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.43.96"), 12124)}, "/Users/Evgenii/Desktop/Fuse/attendance-app/attendance-app.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("attendance-app");
}
}
}
