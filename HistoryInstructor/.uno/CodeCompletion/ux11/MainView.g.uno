...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        public override object New()
        {
            ...
            temp_Y_inst = new historyInstructor_FuseTranslation_Y_Property(temp, __selector0);
            var temp1 = new Fuse.Controls.Text();
            temp1_Value_inst = new historyInstructor_FuseControlsText_Value_Property(temp1, __selector1);
            var temp2 = new Body();
            temp2_Value_inst = new historyInstructor_Body_Value_Property(temp2, __selector1);
            var temp3 = new Body();
            temp3_Value_inst = new historyInstructor_Body_Value_Property(temp3, __selector1);
            var temp4 = new Body();
            temp4_Value_inst = new historyInstructor_Body_Value_Property(temp4, __selector1);
            self_Background_inst = new historyInstructor_FuseControlsPage_Background_Property(self, __selector2);
            var temp5 = new Fuse.Reactive.DataBinding<float>(temp_Y_inst, "ypos");
            var temp6 = new Fuse.Controls.StackPanel();
            var temp7 = new Fuse.Reactive.DataBinding<string>(temp1_Value_inst, "TOD");
            var temp8 = new Fuse.Controls.StackPanel();
            var temp9 = new Fuse.Reactive.DataBinding<string>(temp2_Value_inst, "Total");
            var temp10 = new Fuse.Reactive.DataBinding<string>(temp3_Value_inst, "Absence");
            var temp11 = new Fuse.Reactive.DataBinding<string>(temp4_Value_inst, "Late");
            var temp12 = new Fuse.Navigation.ExitingAnimation();
            var temp13 = new Fuse.Animations.Move();
            var temp14 = new Fuse.Navigation.EnteringAnimation();
            var temp15 = new Fuse.Animations.Move();
            var temp16 = new Fuse.Navigation.EnteringAnimation();
            var temp17 = new Fuse.Animations.Move();
            var temp18 = new Fuse.Reactive.DataBinding<Fuse.Drawing.Brush>(self_Background_inst, "bgcolor");
            self.ClipToBounds = true;
            temp.RelativeTo = Fuse.TranslationModes.Size;
            temp.Bindings.Add(temp5);
            temp6.Width = new Uno.UX.Size(43f, Uno.UX.Unit.Percent);
    ...
    void InitializeUX()
    {
        ...
        temp_Items_inst = new historyInstructor_FuseReactiveEach_Items_Property(temp, __selector0);
