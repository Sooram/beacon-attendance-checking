...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.0.2"), 12124)}, "C:\\Users\\Sooram\\Documents\\fuse\\signUp\\signUp.unoproj", GetBundle, new string[] { })
{
