...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        public override object New()
        {
            ...
            temp_Y_inst = new historyapp_FuseTranslation_Y_Property(temp, __selector0);
            var temp1 = new Fuse.Controls.Text();
            temp1_Value_inst = new historyapp_FuseControlsText_Value_Property(temp1, __selector1);
            var temp2 = new Body();
            temp2_Value_inst = new historyapp_Body_Value_Property(temp2, __selector1);
            var temp3 = new Body();
            temp3_Value_inst = new historyapp_Body_Value_Property(temp3, __selector1);
            var temp4 = new Body();
            temp4_Value_inst = new historyapp_Body_Value_Property(temp4, __selector1);
            self_Background_inst = new historyapp_FuseControlsPage_Background_Property(self, __selector2);
    ...
    void InitializeUX()
    {
        ...
        temp_Items_inst = new historyapp_FuseReactiveEach_Items_Property(temp, __selector0);
