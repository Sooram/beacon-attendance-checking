...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("147.46.209.219"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124)}, "/Users/Evgenii/Desktop/Fuse/History-app/history-app.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("history-app");
}
}
}
