...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("172.30.1.25"), 12124)}, "/Users/SEOYOMI/fuse/project/project.unoproj", GetBundle, new string[] { ""})
{
...
{
return Uno.IO.Bundle.Get("project");
}
}
}
