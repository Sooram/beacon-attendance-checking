...
public partial class MainView: Fuse.App
{
    ...
    internal Fuse.Controls.Rectangle classes;
    ...
    void InitializeUX()
    {
        ...
        classes = new Fuse.Controls.Rectangle();
        var temp33 = new Fuse.Effects.DropShadow();
        var temp34 = new Fuse.Controls.DockPanel();
        var temp35 = new Fuse.Controls.Text();
        var temp36 = new Fuse.Font(new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../../Assets/Fonts/Roboto-Bold.ttf")));
        var temp37 = new Fuse.Controls.Text();
        var temp38 = new Fuse.Font(new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../../Assets/Fonts/Roboto-Bold.ttf")));
        var temp39 = new Fuse.Controls.Circle();
        var temp40 = new Fuse.Effects.DropShadow();
        var temp41 = new Fuse.Navigation.WhileActive();
        var temp42 = new Fuse.Triggers.Actions.Set<bool>(shrinkIndicatorWidth_Value_inst);
        var temp43 = new Fuse.Triggers.Actions.Set<float4>(indicatorColorAttractor_Value_inst);
        var temp44 = new Fuse.Triggers.Actions.Set<float4>(bgColorAttractor_Value_inst);
        var temp45 = new Fuse.Triggers.Actions.Set<float4>(titleTextAttractor_Value_inst);
        var temp46 = new Fuse.Navigation.ActivatingAnimation();
        var temp47 = new Fuse.Animations.Change<float>(h1_Opacity_inst);
        var temp48 = new Fuse.Animations.Change<float>(col1_Width_inst);
        var temp49 = new Fuse.Animations.Change<float4>(c1_Color_inst);
        page2 = new Fuse.Controls.Page();
        var temp50 = new PagePlaceholder();
        var temp51 = new Fuse.Navigation.WhileActive();
        var temp52 = new Fuse.Triggers.Actions.Set<bool>(shrinkIndicatorWidth_Value_inst);
        var temp53 = new Fuse.Triggers.Actions.Set<float4>(indicatorColorAttractor_Value_inst);
        var temp54 = new Fuse.Triggers.Actions.Set<float4>(bgColorAttractor_Value_inst);
        var temp55 = new Fuse.Triggers.Actions.Set<float4>(titleTextAttractor_Value_inst);
        var temp56 = new Fuse.Navigation.ActivatingAnimation();
        var temp57 = new Fuse.Animations.Move();
        var temp58 = new Fuse.Navigation.ActivatingAnimation();
        var temp59 = new Fuse.Animations.Change<float>(h2_Opacity_inst);
        var temp60 = new Fuse.Animations.Change<float>(col2_Width_inst);
        var temp61 = new Fuse.Animations.Change<float4>(c2_Color_inst);
        ...
        page1.Children.Add(classes);
        page1.Children.Add(temp41);
        page1.Children.Add(temp46);
        classes.CornerRadius = float4(6f, 6f, 6f, 6f);
        classes.Color = Fuse.Drawing.Colors.White;
        classes.Height = new Uno.UX.Size(100f, Uno.UX.Unit.Unspecified);
        classes.Margin = float4(10f, 10f, 10f, 10f);
        classes.Name = __selector21;
        classes.Effects.Add(temp33);
        classes.Children.Add(temp34);
        temp34.Margin = float4(15f, 15f, 15f, 15f);
        ...
        temp37.Font = temp38;
        temp39.Color = Fuse.Drawing.Colors.Red;
        temp39.Width = new Uno.UX.Size(30f, Uno.UX.Unit.Unspecified);
        ...
        temp42.Value = false;
        temp43.Value = ColorPalette.SkyBlue;
        temp44.Value = ColorPalette.SkyBlue;
        temp45.Value = ColorPalette.SkyBlue;
        temp46.Animators.Add(temp47);
        temp46.Animators.Add(temp48);
        temp46.Animators.Add(temp49);
        temp47.Value = 1f;
        temp48.Value = 2f;
        temp49.Value = Fuse.Drawing.Colors.White;
        page2.Name = __selector22;
        page2.Children.Add(temp50);
        page2.Children.Add(temp51);
        page2.Children.Add(temp56);
        page2.Children.Add(temp58);
        temp50.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../../Assets/screen4.png"));
        ...
        temp52.Value = false;
        temp53.Value = ColorPalette.Pink;
        temp54.Value = ColorPalette.Pink;
        temp55.Value = ColorPalette.Pink;
        temp56.Scale = 1f;
        temp56.Animators.Add(temp57);
        temp57.X = 1f;
        temp57.RelativeTo = Fuse.Elements.TranslationModes.PositionOffset;
        temp57.RelativeNode = p4;
        temp57.Target = indicator;
        temp58.Animators.Add(temp59);
        temp58.Animators.Add(temp60);
        temp58.Animators.Add(temp61);
        temp59.Value = 1f;
        temp60.Value = 2f;
        temp61.Value = Fuse.Drawing.Colors.White;
    ...
    static global::Uno.UX.Selector __selector21 = "classes";
