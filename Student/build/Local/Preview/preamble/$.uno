...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("147.47.191.137"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124)}, "F:\\2016년 2학기\\프로젝트\\Fuse project\\Student\\Student.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("Student");
}
}
}
