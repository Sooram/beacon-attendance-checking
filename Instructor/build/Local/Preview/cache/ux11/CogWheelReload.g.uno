...
public partial class CogWheelReload: Fuse.Controls.Panel
{
    ...
    void InitializeUX()
    {
        ...
        cogPanel_MinHeight_inst = new Instructor_FuseControlsPanel_MinHeight_Property(cogPanel, __selector0);
        cogPanel_Height_inst = new Instructor_FuseControlsPanel_Height_Property(cogPanel, __selector1);
        cog1Rotation = new Fuse.Rotation();
        cog1Rotation_Degrees_inst = new Instructor_FuseRotation_Degrees_Property(cog1Rotation, __selector2);
        cog2Rotation = new Fuse.Rotation();
        cog2Rotation_Degrees_inst = new Instructor_FuseRotation_Degrees_Property(cog2Rotation, __selector2);
        cog3Rotation = new Fuse.Rotation();
        cog3Rotation_Degrees_inst = new Instructor_FuseRotation_Degrees_Property(cog3Rotation, __selector2);
        cog4Rotation = new Fuse.Rotation();
        cog4Rotation_Degrees_inst = new Instructor_FuseRotation_Degrees_Property(cog4Rotation, __selector2);
        cog5Rotation = new Fuse.Rotation();
        cog5Rotation_Degrees_inst = new Instructor_FuseRotation_Degrees_Property(cog5Rotation, __selector2);
        cog2Trans = new Fuse.Translation();
        cog2Trans_Y_inst = new Instructor_FuseTranslation_Y_Property(cog2Trans, __selector3);
        cog3Trans = new Fuse.Translation();
        cog3Trans_Y_inst = new Instructor_FuseTranslation_Y_Property(cog3Trans, __selector3);
        cog4Trans = new Fuse.Translation();
        cog4Trans_Y_inst = new Instructor_FuseTranslation_Y_Property(cog4Trans, __selector3);
        cog5Trans = new Fuse.Translation();
        cog5Trans_Y_inst = new Instructor_FuseTranslation_Y_Property(cog5Trans, __selector3);
        retainSpace = new Fuse.Triggers.WhileTrue();
        retainSpace_Value_inst = new Instructor_FuseTriggersWhileTrue_Value_Property(retainSpace, __selector4);
        var temp = new Fuse.Triggers.PullToReload();
        temp_IsLoading_inst = new Instructor_FuseTriggersPullToReload_IsLoading_Property(temp, __selector5);
